...
| OPS_IDP_URL                          | O (M for IDP integration)         | -                                                | [https://keycloak.k8s.org](https://github.com/Netcracker/qubership-env-checker) | URL to keycloak. If IDP parameters are not defined then access to Env Checker is allowable via Jupiter default token                                           |
